...
import com.slimebreeder.entity.slime.BlackSlimeEntity;
...
@OnlyIn(Dist.CLIENT)
public class BlackSlimeRenderer extends MobRenderer<BlackSlimeEntity, SlimeModel<BlackSlimeEntity>> {
    ...
    @Override
    public void render(BlackSlimeEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
        this.shadowRadius = 0.25F * (float)pEntity.getSize();
        super.render(pEntity, pEntityYaw, pPartialTicks, pMatrixStack, pBuffer, pPackedLight);
    }

    @Override
    protected void scale(BlackSlimeEntity pLivingEntity, PoseStack pMatrixStack, float pPartialTickTime) {
        float f = 0.999F;
    ...
    @Override
    public ResourceLocation getTextureLocation(BlackSlimeEntity pEntity) {
        return new ResourceLocation(SlimeBreeder.MODID, "textures/entity/slime/black_slime.png");
    }
}
