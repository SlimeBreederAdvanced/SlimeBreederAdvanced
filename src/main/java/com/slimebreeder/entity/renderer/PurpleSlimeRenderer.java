...
import com.slimebreeder.entity.slime.PurpleSlimeEntity;
...
@OnlyIn(Dist.CLIENT)
public class PurpleSlimeRenderer extends MobRenderer<PurpleSlimeEntity, SlimeModel<PurpleSlimeEntity>> {

    public PurpleSlimeRenderer(EntityRendererProvider.Context pContext) {
    ...
    @Override
    public void render(PurpleSlimeEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
    ...
    public ResourceLocation getTextureLocation(PurpleSlimeEntity pEntity) {
        return new ResourceLocation(SlimeBreeder.MODID, "textures/entity/slime/purple_slime.png");
    }
}
