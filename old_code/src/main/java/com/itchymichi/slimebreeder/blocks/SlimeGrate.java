...
import com.itchymichi.slimebreeder.items.SlimeGrateItem;
...
public class SlimeGrate extends Block implements IHasModel
{

	public SlimeGrate(String name, Material materialIn) 
	{
		super(materialIn);
		...
		SlimeGrateItem SLIMEGRATE = new SlimeGrateItem("slimegrate", true, SlimeBreeder.proxy.slimetab, 1, ((Block)(this)));
