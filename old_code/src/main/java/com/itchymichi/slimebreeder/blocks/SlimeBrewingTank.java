...
import com.itchymichi.slimebreeder.items.SlimeBrewingTankItem;
...
public class SlimeBrewingTank extends Block implements IHasModel
{

	public SlimeBrewingTank(String name, Material materialIn) 
	{
		super(materialIn);
		...
		SlimeBrewingTankItem SLIMEBREWINGTANK = new SlimeBrewingTankItem("slimebrewingtank", true, SlimeBreeder.proxy.slimetab, 1, ((Block)(this)));
