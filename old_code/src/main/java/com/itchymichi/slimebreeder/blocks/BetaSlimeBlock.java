...
import com.itchymichi.slimebreeder.items.SlimeBlockItem;
import com.itchymichi.slimebreeder.items.SlimeCoreIrontem;
...
public class SlimeBlock extends Block implements IHasModel
{

	public SlimeBlock(String name, Material materialIn) 
	{
		super(materialIn);
		...
		SlimeBlockItem SLIMEBLOCK = new SlimeBlockItem("slimeblock", true, SlimeBreeder.proxy.slimetab, 1, ((Block)(this)));
