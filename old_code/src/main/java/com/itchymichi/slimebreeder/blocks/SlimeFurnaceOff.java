...
public class SlimeFurnaceOff extends Block implements IHasModel
{

	public SlimeFurnaceOff(String name, Material materialIn) 
	{
		super(materialIn);
		...
		SlimeFurnaceOffItem SLIMEFURNACEOFF = new SlimeFurnaceOffItem("slimefurnaceoff", true, SlimeBreeder.proxy.slimetab, 1, ((Block)(this)));
