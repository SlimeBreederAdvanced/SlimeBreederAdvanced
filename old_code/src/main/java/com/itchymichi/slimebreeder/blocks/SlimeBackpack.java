...
public class SlimeBackpack extends Block implements IHasModel
{

	public SlimeBackpack(String name, Material materialIn) 
	{
		super(materialIn);
		...
		SlimeBackpackItem SLIMEBACKPACK = new SlimeBackpackItem("slimebackpack", true, SlimeBreeder.proxy.slimetab, 1, ((Block)(this)));
