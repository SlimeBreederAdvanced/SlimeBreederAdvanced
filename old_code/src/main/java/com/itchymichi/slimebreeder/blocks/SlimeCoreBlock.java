...
public class SlimeCoreBlock extends Block implements IHasModel
{

	public SlimeCoreBlock(String name, Material materialIn) 
	{
		super(materialIn);
		...
		SlimeCore SLIMECORE = new SlimeCore("slimecore", true, SlimeBreeder.proxy.slimetab, 1, ((Block)(this)));
