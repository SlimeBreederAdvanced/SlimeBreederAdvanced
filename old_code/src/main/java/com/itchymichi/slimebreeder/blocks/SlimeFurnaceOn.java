...
import com.itchymichi.slimebreeder.items.SlimeBackpackItem;
import com.itchymichi.slimebreeder.items.SlimeFurnaceOffItem;
import com.itchymichi.slimebreeder.items.SlimeFurnaceOnItem;
...
public class SlimeFurnaceOn extends Block implements IHasModel
{

	public SlimeFurnaceOn(String name, Material materialIn) 
	{
		super(materialIn);
		...
		SlimeFurnaceOnItem SLIMEFURNACEON = new SlimeFurnaceOnItem("slimefurnaceon", true, SlimeBreeder.proxy.slimetab, 1, ((Block)(this)));
