...
public class SlimeTap extends Block implements IHasModel
{

	public SlimeTap(String name, Material materialIn) 
	{
		super(materialIn);
		...
		SlimeTapItem SLIMETAP = new SlimeTapItem("slimetap", true, SlimeBreeder.proxy.slimetab, 1, ((Block)(this)));
