...
import com.itchymichi.slimebreeder.items.SlimeMonocleItem;
...
public class SlimeMonocle extends Block implements IHasModel
{

	public SlimeMonocle(String name, Material materialIn) 
	{
		super(materialIn);
		...
		SlimeMonocleItem SLIMEMONOCLE = new SlimeMonocleItem("slimemonocle", true, SlimeBreeder.proxy.slimetab, 1, ((Block)(this)));
