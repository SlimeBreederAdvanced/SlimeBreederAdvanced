...
public class ContainerSlimeChest extends InventoryBasic
{

    public ContainerSlimeChest(String inventoryTitle, int slotCount)
    {
        super(inventoryTitle, false, slotCount);
    }

    @SideOnly(Side.CLIENT)
    public ContainerSlimeChest(ITextComponent inventoryTitle, int slotCount)
    {
