...
public class SlimeInfusedSword extends ItemSword implements IHasModel
{
	...
	public SlimeInfusedSword(String name, Boolean inCreativeTab, @Nullable CreativeTabs tab, ToolMaterial materialIn, int size) 
	{
		super(materialIn);
	...
	public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected)
	{
		...
		ItemStack coreItemStack = new ItemStack(Items.GOLDEN_SWORD, 1, 50);
