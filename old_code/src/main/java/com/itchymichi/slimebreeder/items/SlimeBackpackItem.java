...
public class SlimeBackpackItem extends ItemBlock implements IHasModel
{

	public SlimeBackpackItem(String name, Boolean inCreativeTab, @Nullable CreativeTabs tab, int size, Block slimeCore)
	{
		super(slimeCore);
