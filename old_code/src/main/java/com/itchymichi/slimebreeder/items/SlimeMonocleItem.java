...
public class SlimeMonocleItem extends ItemBlock implements IHasModel
{

	public SlimeMonocleItem(String name, Boolean inCreativeTab, @Nullable CreativeTabs tab, int size, Block slimeCore)
	{
		super(slimeCore);
