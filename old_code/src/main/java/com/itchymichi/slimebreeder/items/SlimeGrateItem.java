...
public class SlimeGrateItem extends ItemBlock implements IHasModel
{

	public SlimeGrateItem(String name, Boolean inCreativeTab, @Nullable CreativeTabs tab, int size, Block slimeCore)
	{
		super(slimeCore);
