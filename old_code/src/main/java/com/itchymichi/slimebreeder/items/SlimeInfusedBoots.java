...
public class SlimeInfusedBoots extends ItemArmor implements IHasModel
{
	...
	public SlimeInfusedBoots(String name, Boolean inCreativeTab, @Nullable CreativeTabs tab, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn, int size) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
		...
		if (playerIn.isSneaking())
	    {
			...
			Item newcore = new ItemStack(Items.DIAMOND_BOOTS).getItem();
			ItemStack newcoreStack = new ItemStack(Items.DIAMOND_BOOTS);
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack) 
	{
			...
			if(itemStack.getItemDamage() >= itemStack.getMaxDamage()*0.90)
			{
				...
				player.setItemStackToSlot(EntityEquipmentSlot.FEET, new ItemStack(coreitems.getCompoundTagAt(0)));
			}
	...
	public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected)
	{
		...
		ItemStack coreItemStack = new ItemStack(Items.GOLDEN_BOOTS, 1, 50);
