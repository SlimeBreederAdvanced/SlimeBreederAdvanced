...
public class SlimeInfusedHelm extends ItemArmor implements IHasModel
{
	...
	public SlimeInfusedHelm(String name, Boolean inCreativeTab, @Nullable CreativeTabs tab, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn, int size) 
	{
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack) 
	{
			...
			if(itemStack.getItemDamage() >= itemStack.getMaxDamage()/2)
			{
				...
				player.setItemStackToSlot(EntityEquipmentSlot.HEAD, new ItemStack(coreitems.getCompoundTagAt(0)));
			}
	...
	{
		NBTTagCompound nbt = itemStackIn.getOrCreateSubCompound(SlimeBreeder.MODID);
