...
public class SlimeFurnaceOffItem extends ItemBlock implements IHasModel
{

	public SlimeFurnaceOffItem(String name, Boolean inCreativeTab, @Nullable CreativeTabs tab, int size, Block slimeCore)
	{
		super(slimeCore);
