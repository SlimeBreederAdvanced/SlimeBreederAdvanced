...
public class SlimeTopHatItem extends ItemBlock implements IHasModel
{

	public SlimeTopHatItem(String name, Boolean inCreativeTab, @Nullable CreativeTabs tab, int size, Block slimeCore)
	{
		super(slimeCore);
	...
	public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected)
	{
		...
		if(stack.getTagCompound() != null){
			...
			nbt.setBoolean("top", true);
			nbt.setBoolean("front", false);
			nbt.setBoolean("back", false);
			nbt.setBoolean("lside", false);
			nbt.setBoolean("rside", false);
