...
public class SlimeFurnaceOnItem extends ItemBlock implements IHasModel
{

	public SlimeFurnaceOnItem(String name, Boolean inCreativeTab, @Nullable CreativeTabs tab, int size, Block slimeCore)
	{
		super(slimeCore);
