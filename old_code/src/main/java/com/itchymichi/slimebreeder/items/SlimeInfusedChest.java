...
public class SlimeInfusedChest extends ItemArmor implements IHasModel
{
	...
	public SlimeInfusedChest(String name, Boolean inCreativeTab, @Nullable CreativeTabs tab, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn, int size) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
		...
		if (playerIn.isSneaking())
	    {
			...
			/*Item newcore = new ItemStack(Items.DIAMOND_CHESTPLATE).getItem();
			ItemStack newcoreStack = new ItemStack(Items.DIAMOND_CHESTPLATE);
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack) 
	{
			...
			if(itemStack.getItemDamage() >= itemStack.getMaxDamage()/2)
			{
				...
				player.setItemStackToSlot(EntityEquipmentSlot.CHEST, new ItemStack(coreitems.getCompoundTagAt(0)));
			}
	...
	public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected)
	{
		...
		ItemStack coreItemStack = new ItemStack(Items.GOLDEN_CHESTPLATE, 1, 50);
