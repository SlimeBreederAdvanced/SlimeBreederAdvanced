...
public class SlimeBrewingTankItem extends ItemBlock implements IHasModel
{

	public SlimeBrewingTankItem(String name, Boolean inCreativeTab, @Nullable CreativeTabs tab, int size, Block slimeCore)
	{
		super(slimeCore);
