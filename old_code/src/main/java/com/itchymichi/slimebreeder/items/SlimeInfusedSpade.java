...
public class SlimeInfusedSpade extends ItemSpade implements IHasModel
{
	...
	public SlimeInfusedSpade(String name, Boolean inCreativeTab, @Nullable CreativeTabs tab, ToolMaterial materialIn, int size) 
	{
		super(materialIn);
	...
	public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected)
	{
		...
		ItemStack coreItemStack = new ItemStack(Items.GOLDEN_SHOVEL, 1, 50);
