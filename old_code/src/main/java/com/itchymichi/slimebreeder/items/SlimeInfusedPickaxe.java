...
public class SlimeInfusedPickaxe extends ItemPickaxe implements IHasModel
{
	...
	public SlimeInfusedPickaxe(String name, Boolean inCreativeTab, @Nullable CreativeTabs tab, ToolMaterial materialIn, int size) 
	{
		super(materialIn);
	...
	public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected)
	{
		...
		ItemStack coreItemStack = new ItemStack(Items.GOLDEN_PICKAXE, 1, 50);
