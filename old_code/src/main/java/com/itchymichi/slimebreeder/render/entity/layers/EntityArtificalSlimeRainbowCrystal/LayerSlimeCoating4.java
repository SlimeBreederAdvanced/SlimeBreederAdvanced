...
public class LayerSlimeCoating4 implements LayerRenderer<EntityArtificalSlimeGel>
{
...
public LayerSlimeCoating4(RenderEntityArtificalSlimeRainbowCrystal renderEntityArtificalSlimeGel)
{
...
public void doRenderLayer(EntityArtificalSlimeGel slime2, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
{
	...
	if (entityD.getClass() != slime.getClass())
    {
        ...
        GlStateManager.translate(-0.002, -0.125, -0.002);
