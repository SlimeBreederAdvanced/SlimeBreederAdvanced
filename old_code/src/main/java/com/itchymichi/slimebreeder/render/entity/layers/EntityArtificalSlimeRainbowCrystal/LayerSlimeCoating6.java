...
public class LayerSlimeCoating6 implements LayerRenderer<EntityArtificalSlimeGel>
{
...
public LayerSlimeCoating6(RenderEntityArtificalSlimeRainbowCrystal renderEntityArtificalSlimeGel)
{
...
public void doRenderLayer(EntityArtificalSlimeGel slime2, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
{
	...
	if (entityD.getClass() != slime.getClass())
    {
        ...
        GlStateManager.translate(-0.002, -0.002, -0.125);
