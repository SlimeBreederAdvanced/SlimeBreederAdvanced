...
public class LayerSlimeCoating3 implements LayerRenderer<EntityArtificalSlimeGel>
{
...
public LayerSlimeCoating3(RenderEntityArtificalSlimeRainbowCrystal renderEntityArtificalSlimeGel)
{
...
public void doRenderLayer(EntityArtificalSlimeGel slime2, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
{
	...
	if (entityD.getClass() != slime.getClass())
    {
        ...
        GlStateManager.translate(0.0676, 0.0675, 0.001);
