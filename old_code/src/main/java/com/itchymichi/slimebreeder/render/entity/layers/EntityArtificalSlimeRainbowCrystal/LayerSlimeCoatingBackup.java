...
public class LayerSlimeCoatingBackup implements LayerRenderer<EntityArtificalSlimeRainbowCrystal>
{
...
public LayerSlimeCoatingBackup(RenderEntityArtificalSlimeRainbowCrystal renderEntityArtificalSlimeGel)
{
...
public void doRenderLayer(EntityArtificalSlimeRainbowCrystal slime2, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
{
	...
	if (entityD.getClass() != slime.getClass())
    {
        ...
        GlStateManager.translate(0.0675, 0.001, 0.001);
