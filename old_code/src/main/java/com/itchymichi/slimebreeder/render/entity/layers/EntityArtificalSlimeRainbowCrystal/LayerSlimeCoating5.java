...
public class LayerSlimeCoating5 implements LayerRenderer<EntityArtificalSlimeGel>
{
...
public LayerSlimeCoating5(RenderEntityArtificalSlimeRainbowCrystal renderEntityArtificalSlimeGel)
{
...
public void doRenderLayer(EntityArtificalSlimeGel slime2, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
{
	...
	if (entityD.getClass() != slime.getClass())
    {
        ...
        GlStateManager.translate(0.001, 0.0674, 0.0675);
