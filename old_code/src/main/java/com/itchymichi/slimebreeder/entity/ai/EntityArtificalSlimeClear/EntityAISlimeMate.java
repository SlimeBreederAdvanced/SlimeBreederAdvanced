...
public class EntityAISlimeMate extends EntityAIBase
{
    ...
    public EntityAISlimeMate(EntityAnimal animal, double speedIn)
    {
        this(animal, speedIn, animal.getClass());
    }

    public EntityAISlimeMate(EntityAnimal p_i47306_1_, double p_i47306_2_, Class <? extends EntityAnimal > p_i47306_4_)
    {
    ...
    private void spawnBaby()
    {
        ...
        if (cancelled) {
        	...
        	this.animal.setGrowingAge((((EntityColorSlimeBase)((EntityColorSlimeBase) animal)).getBreedingSpeed()));
            this.targetMate.setGrowingAge((((EntityColorSlimeBase)((EntityColorSlimeBase) targetMate)).getBreedingSpeed()));
        ...
        if (entityageable != null)
        {
            ...
            entityageable.setGrowingAge((((EntityColorSlimeBase)((EntityColorSlimeBase) entityageable)).getBreedingSpeed()));
