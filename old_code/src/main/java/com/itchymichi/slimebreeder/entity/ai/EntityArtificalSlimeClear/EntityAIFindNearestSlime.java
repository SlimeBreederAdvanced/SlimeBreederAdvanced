...
public class EntityAIFindNearestSlime extends EntityAIBase
{
    ...
    public EntityAIFindNearestSlime(EntityLiving mobIn, Class <? extends EntityLivingBase > p_i45884_2_)
    {
        this.mob = mobIn;
        ...
        this.predicate = new Predicate<EntityLivingBase>()
        {
            ...
            {
                double d0 = EntityAIFindNearestSlime.this.getFollowRange();
                ...
                return p_apply_1_.isInvisible() ? false : ((double)p_apply_1_.getDistance(EntityAIFindNearestSlime.this.mob) > d0 ? false : EntityAITarget.isSuitableTarget(EntityAIFindNearestSlime.this.mob, p_apply_1_, false, true));
            }
        };
    ...
    public boolean shouldExecute()
    {
        ...
        {
        	if(this.mob.getActivePotionEffect(SlimeBreeder.proxy.slimeBreedable) != null && list.get(0).getActivePotionEffect(SlimeBreeder.proxy.slimeBreedable) != null && this.mob.getActivePotionEffect(SlimeBreeder.proxy.slimeHunger) == null && list.get(0).getActivePotionEffect(SlimeBreeder.proxy.slimeHunger) == null)
        	{
